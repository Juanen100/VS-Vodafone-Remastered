...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		states.StoryMenuState.onStoryMenuState = true;
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['VS Vodafone Team'],
			['Strexx',			'strexx',			'Artist of VS Vodafone',					 		'https://www.youtube.com/@strexx8047',		'444444'],
			['Juanen100',		'juanen',			'Programmer of VS Vodafone',						'https://www.youtube.com/@juanen150',		'0099cb'],
			['DavidContR',		'david',			'Composer of VS Vodafone',						 	'https://www.youtube.com/@DavidContR',		'14967B'],
			['Sammie',			'sami',				'Charter of VS Vodafone',						 	 '',										'c37c4b'],
			[''],
			['Psych Engine Team'],
	...
	override function update(elapsed:Float)
	{
		...
		if(!quitting)
		{
			...
			if (controls.BACK)
			{
				...
				MusicBeatState.switchState(new VodafoneMainMenu());
				quitting = true;
			}
		}
