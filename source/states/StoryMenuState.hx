...
class StoryMenuState extends MusicBeatState
{
	...
	public static var onStoryMenuState:Bool = true;
	...
	override function update(elapsed:Float)
	{
		...
		if (!movedBack && !selectedWeek)
		{
			...
			else if (controls.ACCEPT && !openedSubState)
			{
				selectWeek();
			}
		}

		if (controls.BACK && !movedBack && !selectedWeek && !openedSubState)
		{
